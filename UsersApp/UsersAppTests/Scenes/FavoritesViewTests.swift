...
final class FavoritesViewTests: XCTestCase {
    var sut: FavoritesViewSpy!
    
    override func setUp() {
        super.setUp()
        sut = FavoritesViewSpy()
    }
...
// MARK: - FavoritesViewSpy
final class FavoritesViewSpy: UIView, FavoritesViewProtocol {
    var delegate: UsersApp.FavoritesViewDelegate?
...
extension FavoritesViewTests: UITableViewDataSource, UITableViewDelegate {
